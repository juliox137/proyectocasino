...
input[type=submit] {color:yellow;
    ...
    <body bgcolor="#98BDFF">
        ...
        <?php error_reporting(0) ?>
            ...
            <br><br><br>
            <a href="empleados_e.php"><button type="button" style="float: middle; width:200px ">Gestion de Empleados</button></a>
            <br><br><br>
            <a href="venyreg_e.php"><button type="button"  style="float: middle; width:200px">Ventas y Registros</button></a>
            <br><br><br>
            <a href="gestprod_e.php"><button type="button" style="float: middle; width:200px">Gestion Productos</button></a>
